...
namespace SkillFactory.ToDOList.BLL
{
    ...
    //public IniSettings()
    //{
    //    //SetSettingIntoIniFile(1);
    //    _dalType = GetSettingIntoIniFile();
    //}

    //void SetSettingIntoIniFile(int dalType)
    //{
    //    _dalType = dalType;
    //    XmlSerializer serializer = new XmlSerializer(typeof(IniSettings));
    //    using (FileStream writer = new FileStream("settings.xml", FileMode.OpenOrCreate))
    //    {

    //        serializer.Serialize(writer, this);
    //    }
    //}
    //    public int GetSettingIntoIniFile()
    //    {
    //        XmlSerializer serializer = new XmlSerializer(typeof(IniSettings));
    //        using (FileStream stream = new FileStream("settings3.xml", FileMode.OpenOrCreate))
    //        {
    //            IniSettings iniSet = (IniSettings)serializer.Deserialize(stream);
    //            return iniSet._dalType;
    //        }
    //    }
    //}
}
